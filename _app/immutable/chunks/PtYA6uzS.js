import{f as a,a as i,n}from"./csxxA4KV.js";import"./DnvDsx5o.js";const o={layout:"post",title:"Osmosis Driven Development",author:["Ken Cross"],tags:["Opinion","Software Engineering"],excerpt:"How context drives the engineering process",date:"2018-10-29T00:00:00.000Z",modified:"2020-08-08T00:00:00.000Z",draft:!1},{layout:c,title:h,author:m,tags:d,excerpt:u,date:p,modified:f,draft:g}=o;var s=a(`<p>In a magical world where all tasks are well defined, performing task or implement feature is a simple matter of doing.
...
This makes life more comfortable since overly ambitious partner commitments are less likely to occur, if we posit that colleagues are not malicious, otherwise all bets are off.</p>`,1);function b(e){var t=s();n(26),i(e,t)}export{b as default,o as metadata};
