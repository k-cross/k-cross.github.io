import{f as a,a as i,n as o}from"./csxxA4KV.js";import"./DnvDsx5o.js";const n={layout:"post",title:"Three Phase Commit Data Migrations",author:["Ken Cross"],excerpt:"A technique describing zero-downtime data migrations",tags:["Technique","Software Engineering"],date:"2018-12-09T00:00:00.000Z",modified:"2020-07-16T00:00:00.000Z",draft:!1},{layout:h,title:d,author:p,excerpt:c,tags:m,date:u,modified:g,draft:f}=n;var s=a(`<p>Paving a path towards continuous delivery and zero-downtime deployments is a challenging pursuit especially when each project employs its own strategy.
...
All good things result for all parties that have a lot to loose when things go wrong.</p>`,1);function b(e){var t=s();o(28),i(e,t)}export{b as default,n as metadata};
